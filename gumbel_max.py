...
def main(args):   
    ...
    for i in range(args.trials):
        ...
        base_classifier, out_store = train_(args, args.out_dir + BASE_CLASSIFIER, (train_loader, test_loader), seed, ds, loss_fn=GumbelCE.apply, cifar_10_1_loader=cifar_10_1_loader)
        ...
        delphi_, out_store = train_(args, args.out_dir + LOGIT_BALL_CLASSIFIER, (train_loader, test_loader), seed, ds, loss_fn=TruncatedCE.apply, phi=phi, cifar_10_1_loader=cifar_10_1_loader)
